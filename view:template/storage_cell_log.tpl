...
<div id="content" class="storage-cell log">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="navigate">
					...
					<a href="javascript:void(0);" class="btn btn-primary"><?php echo $button_log; ?></a>
					<a href="<?php echo $service_link; ?>" class="btn btn-default"><?php echo $button_service; ?></a>
				</div>
			</div>
			<div class="panel-body">
				<div class="tab-content">
					<textarea wrap="off" rows="15" readonly class="form-control" style="height: auto;"><?php echo $log_content; ?></textarea>
				</div>
			</div>
		</div>
	</div>
